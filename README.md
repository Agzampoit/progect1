...
1. Здесь по 250 элементов в каждом классе и ковариационные матрицы равны, поэтому разделяющая линия вырождается в прямую(данный случай рассматривается в алгоритме ЛДФ(Линейный дискриминант Фишера), который мы рассмотрим позже):  
![plugin1](https://user-images.githubusercontent.com/43229815/50232435-fb3a8a80-03c1-11e9-9c66-aaf117847952.png)  
2. Здесь также по 250 элементов в каждом классе:  
...
3. Здесь по 50 эелементов каждом классе:  
Ковариационные матрицы:  
```diff  
